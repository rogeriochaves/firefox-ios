...
private let browsingActivityType: String = "app.rchaves.ios.firefox.browsing"
...
extension UserActivityHandler {
    func spotlightIndex(_ page: ReadabilityResult, for tab: Tab) {
        ...
        let item = CSSearchableItem(uniqueIdentifier: identifier, domainIdentifier: "app.rchaves.ios.firefox", attributeSet: attributeSet)
